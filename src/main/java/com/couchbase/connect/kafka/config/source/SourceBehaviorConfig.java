...
public interface SourceBehaviorConfig {
   ...
   * <p>
   * As of version 4.3.0, the default filter ignores events from the
   * Couchbase `_system` scope, and also ignores transaction metadata documents
   * (documents whose keys start with "_txn:").
   * <p>
