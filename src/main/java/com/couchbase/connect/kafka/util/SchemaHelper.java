...
public class SchemaHelper {
  ...
  public static Schema parseSchema(String avroSchema) {
  ...
  public static Schema resolveSchema(org.apache.avro.Schema schema, boolean optional) {
  ...
  public static Schema resolveSchema(org.apache.avro.Schema schema) {
    return resolveSchema(schema, false);
  }

  public static void checkStruct(Schema schema, Struct struct) {
  ...
  public static Struct buildStruct(Schema schema, byte[] json) {
    return buildStruct(schema, JsonObject.fromJson(json));
  }

  public static Struct buildStruct(Schema schema, JsonObject json) {
