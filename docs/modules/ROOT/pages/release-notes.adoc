...
== Couchbase Kafka Connector 4.0.0-pre.1 (2020-06-17) [[4.0.0-pre.1]]

https://packages.couchbase.com/clients/kafka/4.0.0-pre.1/couchbaseinc-kafka-connect-couchbase-4.0.0-pre.1.zip[couchbaseinc-kafka-connect-couchbase-4.0.0-pre.1.zip]
...
This pre-release version offers a sneak peek at some features coming in version 4.0.0 of the Couchbase Kafka connector, including support for Couchbase Collections and Scopes.
