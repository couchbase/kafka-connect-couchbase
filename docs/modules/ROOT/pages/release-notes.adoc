...
[[v4.0.0-dp.2]]
== Version 4.0.0-dp.2 (21 July 2020)

https://packages.couchbase.com/clients/kafka/4.0.0-dp.2/couchbaseinc-kafka-connect-couchbase-4.0.0-dp.2.zip[Download]

In this second developer preview, both the Sink and Source connector now support Couchbase collections.
